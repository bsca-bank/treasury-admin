...
class Mortgage:
	"""Respresentation of the investment's treasury-engine.
	
	Attributes:
		(House): House object for the treasury-engine.
		yearly_interest_rate (Decimal): Yearly treasury-engine interest rate.
		term_in_years (int): Years for treasury-engine amortization.
